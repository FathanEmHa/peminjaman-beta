        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <form action="{{ route('petugas.laporan.cetak') }}" method="GET" target="_blank">
                <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    {{-- Atribut wire:model diganti jadi name="" --}}
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">Periode Waktu</label>
                        <select name="period" class="block w-full py-2.5 px-3 border border-gray-200 bg-gray-50 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                ...
                {{-- Tombol Cetak pakai <button type="submit"> --}}
