    ...
    <div class="py-10 max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="p-6 border-b border-gray-100">
                <h3 class="text-lg font-bold text-gray-800">Daftar Alat Inventaris</h3>
            </div>
                ...
                <table class="w-full text-left whitespace-nowrap text-sm">
                    <thead>
                        <tr class="bg-gray-50 border-b border-gray-100 text-gray-500 uppercase tracking-wider text-xs font-semibold">
                            ...
                            <th class="px-6 py-4 text-center">Sisa Fisik Barang</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-100">
                        @forelse ($assets as $asset)
                            <tr class="hover:bg-emerald-50/50 transition-colors group">
                                ...
                                <td class="px-6 py-4 text-center">
                                    @if($asset->stock > 0)
                                        <span class="text-lg font-black text-emerald-600">{{ $asset->stock }} Unit</span>
                                    @else
                                        <span class="text-lg font-black text-rose-600">0 Unit</span>
                                    @endif
                                </td>
                            </tr>
                        @empty
