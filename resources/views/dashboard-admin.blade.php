<x-app-layout>
    ...
    <div class="min-h-screen bg-gray-50/50 py-6 sm:py-10 overflow-x-hidden">
        <div class="max-w-7xl mx-auto space-y-8 min-w-0">
            ...
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                    ...
                    <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex items-center gap-4 hover:border-purple-200 transition-colors group">
                        <div class="p-3 bg-purple-50 text-purple-600 rounded-xl group-hover:bg-purple-600 group-hover:text-white transition-colors shrink-0">
                    ...
                    <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex items-center gap-4 hover:border-blue-200 transition-colors group">
                        <div class="p-3 bg-blue-50 text-blue-600 rounded-xl group-hover:bg-blue-600 group-hover:text-white transition-colors shrink-0">
                    ...
                    <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex items-center gap-4 hover:border-indigo-200 transition-colors group">
                        <div class="p-3 bg-indigo-50 text-indigo-600 rounded-xl group-hover:bg-indigo-600 group-hover:text-white transition-colors shrink-0">
                    ...
                    <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex items-center gap-4 hover:border-rose-200 transition-colors group">
                        <div class="p-3 bg-rose-50 text-rose-600 rounded-xl group-hover:bg-rose-600 group-hover:text-white transition-colors shrink-0">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                @forelse($recentLogs ?? [] as $log)
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-3 py-3 sm:px-6 w-12">
                                            <div class="h-8 w-8 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-700 font-bold text-xs">
                                                {{ substr($log->user->name ?? 'S', 0, 1) }}
                                            </div>
                                        </td>
                                        <td class="px-3 py-3 sm:px-6 min-w-0">
                                            <div class="font-medium text-gray-900 truncate">{{ $log->user->name ?? 'System' }}</div>
                                            <div class="text-xs text-gray-500 truncate">{{ $log->action }}</div>
                                        </td>
                                        <td class="px-3 py-3 sm:px-6 text-right text-xs text-gray-400 whitespace-nowrap">
